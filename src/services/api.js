...
export const api = axios.create({//vamos usar o método dentro de axios chamado create - podemos passar um objeto com configurações
  baseURL: "https://rocketnotesss-api.herokuapp.com", //podemos incluir nessa propriedade baseUrl parte do endereço da api que se repete em todas as requisições para não precisar ficar repetindo ela nas requisições
